...
print("\n_An integer is choosen at random out of the integers from 1 to 100_\n")
...
print("\nFrom {} to {}, there are {} integers that are {} {}: \n{}".format(minValue, maxValue, total, choosen, option2, values))
print("\nThe Probability that an integer is {} {}: {}\n".format(choosen, option2,  total/total_outcome))
