...
Program:
\lstinputlisting[language=Python]{zscript1.py}
...
%figure_1
\begin{figure}[ht!]
\includegraphics[width=16cm,height=8cm,keepaspectratio]{zplot1.pdf}
\centering
\end{figure}
...
Program:
\lstinputlisting[language=Python]{zscript2.py}

\vspace{1cm}

Output:
\lstinputlisting{zoutput2.txt}

%figure_2
\begin{figure}[ht!]
\includegraphics[width=16cm,height=8cm,keepaspectratio]{zplot2.pdf}
\centering
\end{figure}
